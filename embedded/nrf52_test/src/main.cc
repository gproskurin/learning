...
{
	nrf5_lib::uart::uart_send(UART_VCOM, s);
}
...
__attribute__ ((noreturn)) void main()
{
	...
	nrf5_lib::uart::uart_init(UART_VCOM, bsp::pin_vcom_txd.reg);
	...
	nrf5_lib::uart::uart_deinit(UART_VCOM);

	nrf5_lib::uart::uarte_init(UARTE_VCOM, bsp::pin_vcom_txd.reg);
	UARTE_VCOM->INTEN = UARTE_INTEN_ENDTX_Msk;
	logger.init();
